...
//                    params.put("user_info",mUserInfo);
//                    UIHelper.startActicity(getApplicationContext(), HomeActivity.class, );
                    Intent data = new Intent(WXEntryActivity.this, HomeActivity.class);
                    SharedPreferencesUtil.getInstance(WXEntryActivity.this.getApplicationContext()).putSP("user_info", resultStr);
                    startActivity(data);
