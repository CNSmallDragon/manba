...
import com.minyou.manba.databinding.ActivityFansListBinding;
...
public class FansActivity extends DataBindingBaseActivity {
    ...
    private void initView() {
        ...
        binding.fansListRecyclerView.setLayoutManager(manager);
        binding.fansListRecyclerView.addItemDecoration(new RefreshItemDecoration(this,RefreshItemDecoration.VERTICAL_LIST));
        binding.fansListRecyclerView.setAdapter(mAdapter);

        binding.fansListRecyclerView.addOnScrollListener(new RecyclerView.OnScrollListener() {
            int lastVisibleItem ;
            @Override
