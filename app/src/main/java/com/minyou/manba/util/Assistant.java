...
public class Assistant {
    ...
    private static boolean _RSA = (!TextUtils.isEmpty(Appconstant.NET_WORK_PAMAS.RSA_PUBLIC_KEY) && !TextUtils.isEmpty(Appconstant.NET_WORK_PAMAS.RSA_PUBLIC_KEY));

    private static String key = "bixushi16weimima";// 加解密 秘钥

    private static String MD5KEY = "myservice2017GHJKLATYIQ";// 加解密 秘钥
