package com.minyou.manba.dialog;
...
public class SelectDialog extends Dialog implements OnClickListener,OnItemClickListener {
    ...
    private class DialogAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (!mUseCustomColor) {
                mFirstItemColor = mActivity.getResources().getColor(R.color.colorCommon);
                mOtherItemColor = mActivity.getResources().getColor(R.color.colorCommon);
            }
            if (1 == mStrings.size()) {
